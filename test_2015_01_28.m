...
%   for a given granularity, interpolate irs
    for xFadeIndex = 1:(angleOffset / granularity)
        ...
        outIrsCol = firInterp(firB, firA, xFade, 1.2);
        outIrs(:, outIrsColIndex) = outIrsCol;
        xThetaString = intTo3Char(mod(theta-1 + (granularity*xFadeIndex), 360));
        wavwrite(outIrsCol, FS, BPS, ["/home/joe/Documents/space~/svn_drop/impulses/ircam.16.interp.complex/L_IRC_1002_C_R0195_T", xThetaString, irPathTail]);
    end
end
%test_2015_01_28b
