...
directory = [base, "a", num2str(alpha), "/"];
mkdir(directory);
...
print("-dpng", [directory, "eigs", ".png"]);

save("-text", [directory, "data", ".txt"], "lambdas", "r", "r1", "r2", "r3", "eval", "eval1", "eval2", "eval3", "evec", "evec1", "evec2", "evec3", "order", "mics", "winsize", "alpha");
