function ret = hrirConvIrcam(angle, inPath, outPath)
    ...
    outVec = [0; 0];
    fInVec = fft(inVec);
    impulsePathL = ["/home/joe/Documents/space~/svn_drop/impulses/ircam/L_IRC_1002_C_R0195_T", angle, "_P000.wav"];
    impulsePathR = ["/home/joe/Documents/space~/svn_drop/impulses/ircam/R_IRC_1002_C_R0195_T", angle, "_P000.wav"];
    ret = impulsePathL;
